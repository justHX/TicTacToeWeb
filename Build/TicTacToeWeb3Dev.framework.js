...
var ASM_CONSTS = {
  6518528: () => { Module['emscripten_get_now_backup'] = performance.now; },  
 6518583: ($0) => { performance.now = function() { return $0; }; },  
 6518631: ($0) => { performance.now = function() { return $0; }; },  
 6518679: () => { performance.now = Module['emscripten_get_now_backup']; }
};
